...
import 'package:github_trending/ui/language_list/language_list.dart';

class LanguageSelectorPopup extends PopupRoute {
  ...
  Widget buildPage(BuildContext context, Animation<double> animation, Animation<double> secondaryAnimation) {
    return Container(
      ...
      child: LanguageList(onLanguageTapped: () => Navigator.pop(context)),
    );
  }
}
